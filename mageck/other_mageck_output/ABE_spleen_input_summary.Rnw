...
library(xtable)
comparisons=c("spleen1,spleen2,spleen3,spleen4_vs_input_rep1,input_rep2,input_rep3 neg.","spleen1,spleen2,spleen3,spleen4_vs_input_rep1,input_rep2,input_rep3 pos.");
ngenes=c(230,230);
...
\newpage\section{Comparison results of spleen1,spleen2,spleen3,spleen4 vs input rep1,input rep2,input rep3 neg.}

The following figure shows the distribution of RRA score in the comparison spleen1,spleen2,spleen3,spleen4 vs input rep1,input rep2,input rep3 neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of spleen1,spleen2,spleen3,spleen4 vs input rep1,input rep2,input rep3 pos.}

The following figure shows the distribution of RRA score in the comparison spleen1,spleen2,spleen3,spleen4 vs input rep1,input rep2,input rep3 pos., and the RRA scores of 10 genes.
