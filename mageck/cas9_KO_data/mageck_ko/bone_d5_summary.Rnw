...
library(xtable)
comparisons=c("B1,B2,B3,B4_vs_d5_rep2,d5_rep3 neg.","B1,B2,B3,B4_vs_d5_rep2,d5_rep3 pos.");
ngenes=c(230,230);
...
\newpage\section{Comparison results of B1,B2,B3,B4 vs d5 rep2,d5 rep3 neg.}

The following figure shows the distribution of RRA score in the comparison B1,B2,B3,B4 vs d5 rep2,d5 rep3 neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of B1,B2,B3,B4 vs d5 rep2,d5 rep3 pos.}

The following figure shows the distribution of RRA score in the comparison B1,B2,B3,B4 vs d5 rep2,d5 rep3 pos., and the RRA scores of 10 genes.
